...
public class CarController {
    ...
    public ServerResponse<CartVo> unSelectAll(HttpSession session){
        ...
        return CartService.checkedOrUnchecked(user.getId(),null,Const.Cart.UN_CHECKED);
    }
    ...
    public ServerResponse<CartVo> unSelectOne(HttpSession session,Integer productId){
        ...
        return CartService.checkedOrUnchecked(user.getId(),productId,Const.Cart.UN_CHECKED);
    }
